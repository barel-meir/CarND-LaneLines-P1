...
plt.imshow(blurred)
edges = canny(blurred, 250, 300)
plt.imshow(edges)
imshape = image.shape
# # vertices = np.array([[(200,imshape[0]),(200, 200), (imshape[1], 200), (imshape[1],imshape[0])]], dtype=np.int32)
...
hu = hough_lines(edges, rho, theta, threshold, min_line_length, max_line_gap)
w = weighted_img(hu, image)
